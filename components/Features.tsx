...
const Features = () => {
  return (
    <section id="services" className='flex flex-col lg:flex-row items-center overflow-hidden bg-feature-bg bg-center bg-no-repeat py-24'>
  ...
  return(
    <li className="w-full flex flex-1 flex-col items-start">
      ...
      <h2 className="bold-20 
        lg:bold-32 mt-5 capitalize">
          {title}
        </h2>
        
        <p className="regular-16 mt-5 mb-3 bg-white/80
